    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'C', (uint8)'Y', (uint8)' ', (uint8)'C', (uint8)'u', (uint8)'s', (uint8)'t', (uint8)'o', (uint8)'m', (uint8)' ',
(uint8)'B', (uint8)'L', (uint8)'E', 
    ...
    0xFFu, 0xFFu, 0xFFu, 0xFFu, 0x00u, 0x00u, 0xC8u, 0x00u, 
    ...
    (uint8)'P', (uint8)'i', (uint8)'t', (uint8)'c', (uint8)'h', (uint8)' ', (uint8)'R', (uint8)'o', (uint8)'l', (uint8)'l', 
...
const uint8 cyBle_attUuid128[][16u] = {
    /* Orientation */
    { 0x32u, 0x01u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xBBu, 0xCBu, 0x03u, 0x00u },
    /* Filtered Data */
    { 0x32u, 0x01u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xB1u, 0xCBu, 0x03u, 0x00u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* Orientation UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Filtered Data UUID */
    { 0x0008u, (void *)&cyBle_attValues[27] }, /* Filtered Data */
    { 0x000Au, (void *)&cyBle_attValues[35] }, /* Characteristic User Description */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0002u, (void *)&cyBle_attValues[45] }, /* Server Characteristic Configuration */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x11u] = {
    ...
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00001301u /* br,rd,ntf */, 0x0011u, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Eu, 0xCBB1u /* Filtered Data                       */, 0x00091301u /* br,rd,ntf */, 0x0011u, {{0x0008u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Fu, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd        */, 0x000Fu, {{0x000Au, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0010u, 0x2902u /* Client Characteristic Configuration */, 0x00010A04u /* rd,wr     */, 0x0010u, {{0x0002u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0011u, 0x2903u /* Server Characteristic Configuration */, 0x00010A04u /* rd,wr     */, 0x0011u, {{0x0002u, (void *)&cyBle_attValuesLen[10]}} },
};
