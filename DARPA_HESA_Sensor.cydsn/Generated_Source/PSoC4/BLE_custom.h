...
#define CYBLE_ORIENTATION_SERVICE_INDEX   (0x00u) /* Index of Orientation service in the cyBle_customs array */
#define CYBLE_ORIENTATION_FILTERED_DATA_CHAR_INDEX   (0x00u) /* Index of Filtered Data characteristic */
#define CYBLE_ORIENTATION_FILTERED_DATA_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_ORIENTATION_FILTERED_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_ORIENTATION_FILTERED_DATA_SERVER_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x02u) /* Index of Server Characteristic Configuration descriptor */


#define CYBLE_ORIENTATION_SERVICE_HANDLE   (0x000Cu) /* Handle of Orientation service */
#define CYBLE_ORIENTATION_FILTERED_DATA_CHAR_HANDLE   (0x000Eu) /* Handle of Filtered Data characteristic */
#define CYBLE_ORIENTATION_FILTERED_DATA_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x000Fu) /* Handle of Characteristic User Description descriptor */
#define CYBLE_ORIENTATION_FILTERED_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0010u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_ORIENTATION_FILTERED_DATA_SERVER_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0011u) /* Handle of Server Characteristic Configuration descriptor */
